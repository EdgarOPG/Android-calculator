...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final Button botonpow = (Button) findViewById(R.id.Botonpow);
		...
		final Button cos = (Button) findViewById(R.id.Botoncos);
		...
		final Button sin = (Button) findViewById(R.id.Botonsin);
